...
class KF(object):
    ...
    def __init__(self, initial_state_mean=0, n_dim_obs=2):
        self.model = KalmanFilter(initial_state_mean, n_dim_obs)

    def fit(self, measurements):
        self.model = self.model.em(measurements)

    def forecast(self, data):
        return self.model.filter(data)[0]
